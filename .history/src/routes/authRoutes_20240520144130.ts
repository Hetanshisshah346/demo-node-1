...
export class AuthRoutes {
  ...
  private setUpRoutes() {
    const { register, importExcelToDb, excelUserData , singleImageUpload} = this.authController;
    ...
    this.router.post("/image/upload", uploads.single("image"),singleImageUpload);
  }
